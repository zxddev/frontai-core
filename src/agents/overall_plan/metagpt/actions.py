...
请提供专业的建议，包括队伍来源、分阶段部署计划、重点区域、协调配合建议和特殊装备配置。"""
...
请提供专业的建议，包括分诊方案、医院协调、医疗物资优先配置、临时医疗点选址和伤员转运通道规划。"""
...
请提供专业的建议，包括抢修优先级、临时通道方案、危险建筑排查计划、设备部署和电力恢复方案。"""
...
请提供专业的建议，包括安置点选址标准、特殊群体照护、卫生设施配置、饮水和食品发放方案。"""
